...
const definitions: SettingDefinition[] = [
  ...
  { key: "dispatch_enabled", label: "啟用 Adaptive Cascade 快速路由", description: "允許已驗證的唯讀請求在 Hermes 模型前由 Control Plane 處理；關閉時回到原本 Hermes 流程，預設關閉。", type: "boolean", unit: null, defaultValue: false, min: null, max: null, nullable: false, envKey: "PAI_DISPATCH_ENABLED", applyScope: "DISPATCH_INTAKE" },
  { key: "dispatch_semantic_enabled", label: "啟用語意路由（進階）", description: "允許已校準且通過隱私／資源 gate 的語意 tier；主開關關閉或 provider 未驗證時不會啟用，預設關閉。", type: "boolean", unit: null, defaultValue: false, min: null, max: null, nullable: false, envKey: "PAI_DISPATCH_SEMANTIC_ENABLED", applyScope: "DISPATCH_INTAKE" },
  { key: "dispatch_routing_budget_ms", label: "快速路由時間上限", description: "Cascade prepare 的上限，超過後回 Hermes。", type: "integer", unit: "毫秒", defaultValue: 250, min: 1, max: 5000, nullable: false, envKey: "PAI_DISPATCH_ROUTING_BUDGET_MS", applyScope: "DISPATCH_INTAKE" },
  { key: "dispatch_proposal_ttl_ms", label: "快速路由 proposal 保存時間", description: "prepare proposal 可被 commit 的最長時間。", type: "integer", unit: "毫秒", defaultValue: 30000, min: 1000, max: 300000, nullable: false, envKey: "PAI_DISPATCH_PROPOSAL_TTL_MS", applyScope: "DISPATCH_INTAKE" },
  { key: "dispatch_learning_enabled", label: "保存路由學習資料", description: "保存 Hermes structured observation 與候選規則 evidence；不會自動 promotion。", type: "boolean", unit: null, defaultValue: false, min: null, max: null, nullable: false, envKey: "PAI_DISPATCH_LEARNING_ENABLED", applyScope: "DISPATCH_LEARNING" },
  ...
  { key: "agent_work_skills_enabled", label: "啟用工作技能", description: "允許建立、驗證與固定版本化的任務工作技能。", type: "boolean", unit: null, defaultValue: false, min: null, max: null, nullable: false, envKey: "PAI_AGENT_WORK_SKILLS_ENABLED", applyScope: "AGENT_WORK_INTAKE" },
  { key: "agent_work_routines_enabled", label: "啟用例行工作", description: "允許將固定技能提交給 Hermes native scheduler 同步。", type: "boolean", unit: null, defaultValue: false, min: null, max: null, nullable: false, envKey: "PAI_AGENT_WORK_ROUTINES_ENABLED", applyScope: "AGENT_WORK_INTAKE" },
  { key: "agent_work_goals_enabled", label: "啟用長期目標", description: "允許保存 Goal、里程碑與預算事實。", type: "boolean", unit: null, defaultValue: false, min: null, max: null, nullable: false, envKey: "PAI_AGENT_WORK_GOALS_ENABLED", applyScope: "AGENT_WORK_INTAKE" },
  { key: "agent_work_attention_enabled", label: "啟用待處理", description: "允許建立與查詢統一待處理事件投影。", type: "boolean", unit: null, defaultValue: false, min: null, max: null, nullable: false, envKey: "PAI_AGENT_WORK_ATTENTION_ENABLED", applyScope: "AGENT_WORK_INTAKE" },
  { key: "agent_work_memory_enabled", label: "啟用記憶引用", description: "只有 ContextHub adapter 通過驗證後才可啟用。", type: "boolean", unit: null, defaultValue: false, min: null, max: null, nullable: false, envKey: "PAI_AGENT_WORK_MEMORY_ENABLED", applyScope: "AGENT_WORK_INTAKE" },
  { key: "agent_work_browser_enabled", label: "啟用瀏覽器 Worker", description: "只有受控 browser broker 與停止證據驗證後才可啟用。", type: "boolean", unit: null, defaultValue: false, min: null, max: null, nullable: false, envKey: "PAI_AGENT_WORK_BROWSER_ENABLED", applyScope: "AGENT_WORK_INTAKE" },
  { key: "agent_work_teaching_enabled", label: "啟用示範學習", description: "只有 browser session 隔離與隱私錄製驗證後才可啟用。", type: "boolean", unit: null, defaultValue: false, min: null, max: null, nullable: false, envKey: "PAI_AGENT_WORK_TEACHING_ENABLED", applyScope: "AGENT_WORK_INTAKE" },
];
