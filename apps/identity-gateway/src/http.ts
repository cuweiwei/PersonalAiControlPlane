...
function html(response: ServerResponse): void {
  ...
  const hudStyle = document.createElement('style'); hudStyle.textContent = ':root{color-scheme:dark;font-family:Inter,ui-sans-serif,system-ui,sans-serif;--hud-bg:#030a11;--hud-surface:rgba(6,18,29,.9);--hud-line:rgba(76,203,236,.55);--hud-bright:#43e8ff;--hud-copy:#b9d0dc;--hud-muted:#7f9aaa}body{position:relative;overflow-x:hidden;color:#e9fbff;background:radial-gradient(circle at 14% 0%,rgba(20,83,117,.48),transparent 33rem),var(--hud-bg)}body:before{position:fixed;z-index:0;inset:0;pointer-events:none;content:"";opacity:.34;background-image:linear-gradient(rgba(67,232,255,.055) 1px,transparent 1px),linear-gradient(90deg,rgba(67,232,255,.055) 1px,transparent 1px);background-size:44px 44px;mask-image:linear-gradient(to bottom,#000,transparent 90%)}main{position:relative;z-index:1;width:min(92vw,560px);padding:clamp(1.5rem,5vw,2.2rem);overflow:hidden;background:linear-gradient(145deg,rgba(8,29,45,.95),rgba(4,14,24,.96));border:1px solid var(--hud-line);border-radius:.6rem;box-shadow:0 24px 80px #0009,inset 0 0 36px rgba(67,232,255,.05)}main:before{position:absolute;inset:0;pointer-events:none;content:"";border:1px solid rgba(67,232,255,.2);clip-path:polygon(0 0,18px 0,18px 1px,calc(100% - 18px) 1px,calc(100% - 18px) 0,100% 0,100% 18px,calc(100% - 1px) 18px,calc(100% - 1px) calc(100% - 18px),100% calc(100% - 18px),100% 100%,calc(100% - 18px) 100%,calc(100% - 18px) calc(100% - 1px),18px calc(100% - 1px),18px 100%,0 100%,0 calc(100% - 18px),1px calc(100% - 18px),1px 18px,0 18px)}main:after{position:absolute;top:-7rem;right:-7rem;width:17rem;height:17rem;pointer-events:none;content:"";border:1px solid rgba(67,232,255,.18);border-radius:50%;box-shadow:0 0 0 2rem rgba(67,232,255,.035),0 0 0 4.5rem rgba(67,232,255,.025)}main>*{position:relative;z-index:1}h1{margin:.25rem 0 .6rem;font-size:clamp(1.7rem,5vw,2.35rem);letter-spacing:-.03em;text-shadow:0 0 20px rgba(67,232,255,.2)}h2{color:#e9fbff}p{color:var(--hud-copy);line-height:1.55}.eyebrow{letter-spacing:.16em;font-size:.72rem;color:var(--hud-bright);font-weight:800}label{display:block;margin:16px 0 6px;color:#d7e9f0;font-size:.9rem;font-weight:700}input{box-sizing:border-box;width:100%;padding:12px 13px;color:#e9fbff;background:rgba(2,10,17,.92);border:1px solid var(--hud-line);border-radius:.35rem;font:inherit;transition:border-color 180ms ease,box-shadow 180ms ease}input:focus{border-color:var(--hud-bright);outline:2px solid rgba(67,232,255,.48);outline-offset:1px;box-shadow:0 0 0 2px rgba(67,232,255,.12),inset 0 0 14px rgba(67,232,255,.08)}button{position:relative;width:100%;margin-top:18px;padding:12px;overflow:hidden;color:#021017;background:linear-gradient(135deg,#86f1ff,#43c9e9);border:1px solid rgba(166,248,255,.8);border-radius:.42rem;box-shadow:0 0 18px rgba(67,232,255,.15);font:inherit;font-weight:800;cursor:pointer;transition:transform 120ms ease,box-shadow 180ms ease}button:hover,button:focus-visible{box-shadow:0 0 28px rgba(67,232,255,.32)}button:active{transform:scale(.985)}button:disabled{opacity:.5;cursor:wait}.card{position:relative;margin-top:22px;padding-top:8px;border-top:1px solid var(--hud-line)}.notice{position:relative;padding:12px 14px;color:var(--hud-copy);background:rgba(7,26,40,.82);border:1px solid var(--hud-line);border-radius:.4rem;margin:14px 0}.error{color:#ffb1bb;background:rgba(121,35,53,.34);border-color:rgba(255,121,137,.55)}.success{color:#9af8d0;background:rgba(21,104,79,.32);border-color:rgba(94,230,179,.55)}code{word-break:break-all;white-space:pre-wrap;color:var(--hud-bright)}.hidden{display:none}@media(prefers-reduced-motion:reduce){*,*:before,*:after{transition-duration:.01ms!important;animation-duration:.01ms!important}}'; document.head.append(hudStyle);
