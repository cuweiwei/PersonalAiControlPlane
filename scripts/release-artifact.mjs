...
const manifest = { schemaVersion: 1, commit, sourceRepository: repository, images: [{ service: "pai-identity-gateway", reference: imageReference, digest: imageDigest }, { service: "pai-orchestrator", reference: imageReference, digest: imageDigest }], composeDigest, checks: ["npm run check", "npm test"], createdAt: new Date().toISOString() };
