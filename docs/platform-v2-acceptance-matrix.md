...
| 實際 typed execution、workspace、process/effect evidence | Worker | 提供 offer、attempt evidence、result manifest、artifact refs | Ollama executor live inventory；`aaa6590` 明確傳 generation options；Codex executor/workspace 尚未 provider verified；fresh -05 text result 原樣保存且 validation PASSED（-04 失敗歷史仍保留） | 不把 Ollama inference 當 Codex workspace/diff/test |
